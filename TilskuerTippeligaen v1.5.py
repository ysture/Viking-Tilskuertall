...
for url in urlKamper:
    ...
    # stadium_list.append(re.search('.*\\t(.*)Tilskuere:', arena[1].text).group(1)) Gjør ikke dette, da det gjør at man ikke finner koordinatene til mange av stadionene. I tillegg viser den nåværende stadion også på historiske kamper
...
to_csv(dfSesong, 'tilskuertall_160719')
